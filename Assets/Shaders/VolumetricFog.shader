Shader "Custom/VolumetricFog"
{
    Properties
    {
        ...
        // NEW
        _PlayerExclusionRadius("Player Fog Exclusion Radius", float) = 2.0
    }
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                while(distTravelled < distLimit)
                {
                    ...
                    // NEW: Exclusion check → SKIPS fog close to player
                    if (distance(rayPos, _WorldSpaceCameraPos) < _PlayerExclusionRadius)
                    {
